...
export default function LanguageSelection(){
    ...
    async function saveLanguageSelection(value:string){
    ...
    return(
        <View style={styles.mainCont}>
            <Text style={[styles.titleText, {color: theme.text}]}>{language.language.selectLanguage}</Text>
            <Picker
                selectedValue={language.name}
                onValueChange={(itemValue) => (
                    saveLanguageSelection(itemValue)
                )}
            >
