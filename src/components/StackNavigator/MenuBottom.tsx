...
export default function MenuBottom(){
    ...
    const options = [
        {
            tab: 0,
            icon: IconsMenuBottom.home(30, selectedTab === 0 ? theme.active : 'none', selectedTab === 0 ? 'none' : theme.inactive),
            text: language.menuBottom.home,
            onPress: () => navigation.navigate('HomeStack'),
        },
        {
            tab: 1,
            icon: IconsMenuBottom.animaciones(30, 'none' , selectedTab === 1 ? theme.active : theme.inactive),
