...
const IconsMenuBottom = {
  home: (
    size: number,
    fill = 'black',
    stroke = 'red',
  ) => `<svg width="${size}" height="${size}" fill="${fill}" stroke="${stroke}" stroke-width="15" viewBox="0 0 340.242 330.242" >
  ...
  animaciones: (
    ...
    fill = 'black',
    stroke = 'red',
  ) => `<svg width="${size}" height="${size}" fill="${fill}" stroke="${stroke}" stroke-width="1.5" viewBox="0 0 24 24">
        <path d="M19 7C17.8954 7 17 6.10457 17 5C17 3.89543 17.8954 3 19 3C20.1046 3 21 3.89543 21 5C21 6.10457 20.1046 7 19 7Z" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M4 15.5C7 14.5 9.5 15 12 20C12.5 17 14 12.5 15.5 10" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    `,
};

export { IconsMenuBottom };
